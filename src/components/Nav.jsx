...
function Nav() {
  ...
  return (
    <nav className="absolute left-0 top-0 z-20 h-screen w-screen animate-bg-gradient bg-gradient-to-br from-violet-300 via-amber-200 to-lime-500 bg-[length:400%_400%] font-mono">
