    ...
    <div className="rounded-xl bg-neutral-50/50 p-5 dark:bg-neutral-950/50 sm:w-2/3 md:w-1/2 md:p-7 lg:w-2/5">
      ...
      <div className="text-center">
        <Link to="/work/ollyscloset">
          <div className="mt-3 rounded-xl border-4 border-dashed border-white p-2 hover:border-violet-300 hover:bg-violet-500 hover:text-white  active:border-violet-500 active:bg-violet-700 dark:border-neutral-300 dark:hover:bg-violet-900 sm:flex sm:flex-row-reverse sm:items-center sm:justify-between ">
            <h2>Olly&apos;s Closet</h2>
